...
public final class Utility {
	...
	public static Vector2fc lerp(Vector2fc prev, Vector2fc next, float theta) {
		return new Vector2f(prev).lerp(next, theta);
	}

	public static Vector3fc lerp(Vector3fc prev, Vector3fc next, float theta) {
		return new Vector3f(prev).lerp(next, theta);
	}

	public static Vector4fc lerp(Vector4fc prev, Vector4fc next, float theta) {
		return new Vector4f(prev).lerp(next, theta);
	}

	public static Vector2fc slerp(Vector2fc prev, Vector2fc next, float theta) {
	...
	public static Vector3fc slerp(Vector3fc prev, Vector3fc next, float theta) {
